...
export const API_ENDPOINTS = {
    ...
    feeReminderParentHistory: `${API_BASE_URL}/api/finance/fee-reminders/parent-history`,
    feeReminderHistory: `${API_BASE_URL}/api/finance/fee-reminders/history`,
    feeReminderUploads: `${API_BASE_URL}/api/finance/fee-reminders/uploads`,
    feeReminderPreview: (uploadId: number | string) => `${API_BASE_URL}/api/finance/fee-reminders/${uploadId}/preview`,
    timetableRoleNotifications: `${API_BASE_URL}/timetable/role-notifications`,
    timetableLive: `${API_BASE_URL}/timetable/operations/live`,
