        ...
        >
            <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.heroCard}>
                    ...
                    <Text style={styles.heroTitle}>Register Student</Text>
                    <Text style={styles.heroSubtitle}>SUBRegister Student</Text>
                </View>

                <View style={styles.contentCard}>
                    <Text style={styles.sectionEyebrow}>CURRENT STATUS</Text>
                    <Text style={styles.sectionTitle}>SECTION_Register Student</Text>
