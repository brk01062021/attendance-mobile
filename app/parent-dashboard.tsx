                ...
                >
                    <View style={styles.menuCard}>
                        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.menuScrollContent}>
                            ...
                            <MenuItem title="Fee Reminders" onPress={() => { closeMenu(); router.push({ pathname: '/fee-reminders', params: { parentUserId: parentId, schoolId } } as any); }} />
    ...
    return (
        <>
            <View style={styles.greetingBlock}>
                <Text style={styles.homeGreetingLine} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.75}>Good Morning 🌞 {parentName}</Text>
            </View>
