                ...
                <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.heroCard}>
                        ...
                        <Text style={styles.heroText}>
                            Existing timetable imports are completed from the VidyaSetu Web Portal. Use the Web ERP to upload, validate, review, and publish the school's active timetable.
                        </Text>
                    ...
                    <View style={styles.card}>
                        ...
                        <Step number="3" title="Validate" subtitle="Review accepted rows, errors, and conflicts." />
                        <Step number="4" title="Publish" subtitle="Publish only after validation succeeds and conflicts are zero." last />
                    </View>
