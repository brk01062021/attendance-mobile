...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: 'rgba(255,255,255,0.94)', borderRadius: 26, padding: 20, borderWidth: 1, borderColor: 'rgba(116,83,15,0.2)' },
    label: { color: '#6b551f', fontWeight: '900', marginTop: 14, marginBottom: 8 },
    teacherName: { color: '#2f2106', fontSize: 18, lineHeight: 24, fontWeight: '900' },
    ...
    historyTitle: { color: '#2f2106', fontSize: 20, lineHeight: 25, fontWeight: '900', marginTop: 3 },
    ...
    emptyCard: { backgroundColor: 'rgba(255,255,255,0.88)', borderRadius: 24, padding: 20, borderWidth: 1, borderColor: 'rgba(116,83,15,0.18)' },
    emptyTitle: { color: '#2f2106', fontWeight: '900', fontSize: 17 },
    emptyText: { color: '#6b551f', fontWeight: '700', marginTop: 6, lineHeight: 19 },
    historyCard: { backgroundColor: 'rgba(255,255,255,0.94)', borderRadius: 24, padding: 18, marginBottom: 13, borderWidth: 1, borderColor: 'rgba(116,83,15,0.18)' },
