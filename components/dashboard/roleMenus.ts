...
export const roleMenus: Record<DashboardRole, DashboardMenuConfig[]> = {
    ADMIN: [
        ...
        { icon: '💰', label: 'Fee Reminder', route: '/fee-reminders?role=ADMIN&sourceRole=admin', description: 'Parent fee reminder status' },
    ...
    PRINCIPAL: [
        ...
        { icon: '💰', label: 'Fee Reminder', route: '/fee-reminders?role=PRINCIPAL&sourceRole=principal', description: 'Parent fee reminder status' },
        ...
        { icon: '📥', label: 'Import Existing Timetable', route: '/import-existing-timetable?role=PRINCIPAL&sourceRole=principal', description: 'Upload active timetable' },
        ...
        { icon: '📝', label: 'Register Here', action: 'register', description: 'Teacher, student, parent' },
        { icon: '🧭', label: 'Workspace Setup', route: '/workspace-setup?sourceRole=principal&role=PRINCIPAL', description: 'Setup progress and import unlock' },
